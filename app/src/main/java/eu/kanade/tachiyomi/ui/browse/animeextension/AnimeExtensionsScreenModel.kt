...
class AnimeExtensionsScreenModel(
    ...
    private val getAnimeExtensions: GetAnimeExtensionsByType = Injekt.get(),
    ...
    fun installExtension(extension: AnimeExtension.Available) {
        screenModelScope.launchIO {
            animeExtensionManager.installExtension(extension).collectToInstallUpdate(extension)
        }
    }

    fun updateExtension(extension: AnimeExtension.Installed) {
        screenModelScope.launchIO {
            animeExtensionManager.updateExtension(extension).collectToInstallUpdate(extension)
        }
    }

    fun cancelInstallUpdateExtension(extension: AnimeExtension) {
        animeExtensionManager.cancelInstallUpdateExtension(extension)
    ...
    data class State(
        ...
        val items: AnimeItemGroups = mutableMapOf(),
        val updates: Int = 0,
