...
data object AnimeUpdatesScreen : Screen {
    private fun readResolve(): Any = AnimeUpdatesScreen

    @Composable
    override fun Content() {
        val context = LocalContext.current
        val tab = animeUpdatesTab(context = context, fromMore = true)
        tab.content(PaddingValues(), remember { SnackbarHostState() })
    }
}
