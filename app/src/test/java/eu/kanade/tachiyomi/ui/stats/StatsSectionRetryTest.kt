...
class StatsSectionRetryTest {
    ...
    private fun failedSections() = StatsSections(
        ...
        vocabulary = StatsLoadable(error = true),
        vocabularyGrowth = StatsLoadable(error = true),
    ...
    private fun StatsSections.hasError(section: StatsSection): Boolean = when (section) {
        ...
        StatsSection.VOCABULARY -> vocabulary.error
        StatsSection.VOCABULARY_GROWTH -> vocabularyGrowth.error
